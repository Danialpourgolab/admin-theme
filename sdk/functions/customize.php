 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_ADMTH' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_ADMTH extends WP_Customize_Section {
    public $type = 'admth';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_ADMTH' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_ADMTH extends WP_Customize_Control {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        ...
        $visible  = ' admth-dependency-control';
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'admth_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      $class      = ( $is_complex || $custom ) ? ' admth-customize-complex' : '';
      ...
      echo '<div class="admth-customize-field'. esc_attr( $class ) .'"'. $atts .'>';

      ADMTH::field( $this->field, $this->value(), $this->unique, 'customize' );
