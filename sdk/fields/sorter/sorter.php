 ...
 *
 */
if ( ! class_exists( 'ADMTH_Field_sorter' ) ) {
  class ADMTH_Field_sorter extends ADMTH_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'admth' ),
      ...
      echo '<div class="admth-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="admth-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="admth-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="admth-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="admth-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="admth-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="admth-disabled">';
