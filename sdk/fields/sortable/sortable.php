 ...
 *
 */
if ( ! class_exists( 'ADMTH_Field_sortable' ) ) {
  class ADMTH_Field_sortable extends ADMTH_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="admth-sortable-item">';

          echo '<div class="admth-sortable-content">';
          ...
          ADMTH::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="admth-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
