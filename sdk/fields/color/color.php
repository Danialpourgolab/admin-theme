 ...
 *
 */
if ( ! class_exists( 'ADMTH_Field_color' ) ) {
  class ADMTH_Field_color extends ADMTH_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="admth-color"'. $default_attr . $this->field_attributes() .'/>';
