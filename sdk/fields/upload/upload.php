 ...
 *
 */
if ( ! class_exists( 'ADMTH_Field_upload' ) ) {
  class ADMTH_Field_upload extends ADMTH_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="admth--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary admth--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
